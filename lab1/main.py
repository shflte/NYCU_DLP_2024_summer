...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-d", "--dataset", type=str, default="linear", help="linear/XOR dataset"
    )
    parser.add_argument(
        "-n",
        "--network",
        type=str,
        default="ffn",
        help="feed forward network/convolutional network",
    )
    parser.add_argument(
        "-e", "--epochs", type=int, default=100000, help="number of epochs"
    )
    parser.add_argument(
        "-u", "--units", type=int, default=4, help="number of hidden layer neurons"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="sigmoid",
        help="sigmoid/tanh/relu/leaky relu",
    )
    parser.add_argument(
        "-o", "--optimizer", type=str, default="sgd", help="sgd/momentum/adagrad/adam"
    )
