...
class FullyConnectedNetwork:
    def __init__(
        ...
        self.layer1 = FullyConnectedLayer(
            input_unit, hidden_unit, activation, optimizer, learning_rate
        )
        self.layer2 = FullyConnectedLayer(
            hidden_unit, hidden_unit, activation, optimizer, learning_rate
        )
        self.layer3 = FullyConnectedLayer(
            hidden_unit, output_unit, activation, optimizer, learning_rate
        )
        self.loss_arr = []
        self.epoch_arr = []
